...
| :--- | :--- | :--- | :--- |
| **Projekt könyvtárszerkezete** | Moduláris (mappás) struktúra (api, db, schemas) | Jobb átláthatóság, a felelősségi körök tiszta szétválasztása és a jövőbeli skálázhatóság miatt. Bár a javasolt időkeret rövid, a karbantarthatóság érdekében ez a profibb megközelítés. | Lapos (flat) struktúra (minden egyetlen mappában). |
